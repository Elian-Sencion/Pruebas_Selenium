...
class TestEliminarcuentadeunusuario():
  ...
  def test_eliminarcuentadeunusuario(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".even:nth-child(2) .btn-danger > .fas").click()
