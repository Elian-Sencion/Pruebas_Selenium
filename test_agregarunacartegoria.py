...
class TestAgregarunacartegoria():
  ...
  def test_agregarunacartegoria(self):
    self.driver.get("http://localhost:53922/")
    self.driver.set_window_size(1045, 808)
    ...
    self.driver.find_element(By.ID, "txtdescripcion").send_keys("Amor")
