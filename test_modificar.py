...
class TestModificarunlector():
  ...
  def test_modificarunlector(self):
    self.driver.get("http://localhost:53922/")
    self.driver.set_window_size(1045, 804)
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".even .btn-primary").click()
    self.driver.find_element(By.ID, "txtcorreo").click()
    self.driver.find_element(By.ID, "txtcorreo").send_keys("ruth@gmail.com")
